...
const Social = () => {
  return (
    <div className='home_social'>
        <div className='social_icons'>
          <ui>
            <li>
              ...
              className='home_social-icon' target='_blank' rel="noreferrer">
        ...
        <div className='dark_social'>
          <ui>
            <li>
              <a href='https://www.instagram.com/uidesignnavi/'
              className='dark_social-icon' target='_blank' rel="noreferrer">
                <i className='uil uil-instagram'></i>
              </a>
            </li>
            <li>
